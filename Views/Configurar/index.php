        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input id="rfc" class="form-control" type="text" name="rfc" placeholder="RFC" value="<?php echo $data['RFC']; ?>">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="telefono">Télefono</label>
                    <input id="telefono" class="form-control" type="text" name="telefono" placeholder="Télefono" value="<?php echo $data['telefono']; ?>">
                </div>
            </div>           
            <div class="col-md-5">
                <div class="form-group">
            ...
            <div class="col-md-1">
                <div class="form-group">
                    ...
                    <input id="num_dir_empresa" class="form-control" type="text" name="num_dir_empresa"placeholder="Número" value="<?php echo $data['num_dir_empresa']; ?>">
                </div>
            </div>
            <div class="col-md-6">
                    <div class="form-group">
                        <label for="correo">Email</label>
                        <input id="correo" class="form-control" type="text" name="correo" placeholder="Correo electronico" value="<?php echo $data['email_empresa']; ?>">
                    </div>
                </div>
            <div class="col-md-6">
                <div class="form-group">
